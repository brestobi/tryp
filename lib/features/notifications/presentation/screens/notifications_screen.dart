...
class _NotificationsScreenState extends ConsumerState<NotificationsScreen> {
  ...
  bool _browserPushBusy = false;
  String? _browserPushMessage;

  Future<void> _enableBrowserNotifications() async {
    setState(() {
      _browserPushBusy = true;
      _browserPushMessage = null;
    });
    ...
    try {
      ...
      debugPrint('Browser push permission failed: $error');
      if (mounted) {
        setState(
          () => _browserPushMessage =
      ...
      if (mounted) setState(() => _browserPushBusy = false);
    }
  }
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            if (kIsWeb) _buildBrowserPushBanner(),
  ...
  Widget _buildBrowserPushBanner() {
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  _browserPushMessage ??
                      'Enable browser push for ride updates.',
                  style: TRYPTypography.bodySmall.copyWith(
                    color: TRYPColors.grey,
                  ),
                ),
          ...
          const SizedBox(width: 8),
          TextButton(
            onPressed: _browserPushBusy ? null : _enableBrowserNotifications,
            child: _browserPushBusy
                ? const SizedBox(
                    width: 18,
                    height: 18,
  ...
  Widget build(BuildContext context) {
    ...
    switch (notification.type) {
      ...
      case NotificationType.system:
        iconBg = TRYPColors.accentSoft;
        iconColor = TRYPColors.primaryAlt;
