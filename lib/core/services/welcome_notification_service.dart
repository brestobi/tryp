...
class WelcomeNotificationService {
  ...
  static const String welcomeBody = 'Your account is ready. We are happy to have you onboard.';

  static void showWelcomeNotification({required void Function(String title, String body) callback}) {
    try {
