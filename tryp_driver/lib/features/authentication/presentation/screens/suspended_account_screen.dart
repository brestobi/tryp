        ...
        child: Center(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                const Icon(Icons.block_rounded, color: Color(0xFFB42318), size: 64),
                const SizedBox(height: 24),
                const Text('Account suspended', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w800)),
                const SizedBox(height: 12),
                const Text('You cannot go online or accept rides while your account is suspended.', textAlign: TextAlign.center),
                if (reason != null && reason!.trim().isNotEmpty) ...[
                  const SizedBox(height: 20),
                  Container(
                    width: double.infinity,
                    padding: const EdgeInsets.all(16),
                    decoration: BoxDecoration(color: const Color(0xFFFFF4ED), borderRadius: BorderRadius.circular(14)),
